                    ...
                    <div class="row gy-4 isotope-container" data-aos="fade-up" data-aos-delay="200">
                        ...
                        <?php while ($web = $ambil->fetch_assoc()) { ?>
                            <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-web">
                                <img src="../assets/img/portfolio_photo/<?php echo $web['portfolio_foto']; ?>" class="img-fluid"
                                    alt="Web Project 1" width="500">
                                <div class="portfolio-info">
                                    <h4><?php echo $web['judul_portfolio']; ?></h4>
                                    <p><?php echo $web['tentang']; ?></p>
                                    <a href="../assets/img/portfolio_photo/<?php echo $web['portfolio_foto']; ?>"
                        ...
                        <?php while ($game = $ambil->fetch_assoc()) { ?>
                            <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-games">
                                <img src="../assets/img/portfolio_photo/<?php echo $game['portfolio_foto']; ?>" class="img-fluid"
                                    alt="Web Project 1" width="500">
                                <div class="portfolio-info">
                                    <h4><?php echo $game['judul_portfolio']; ?></h4>
                                    <p><?php echo $game['tentang']; ?></p>
                                    <a href="../assets/img/portfolio_photo/<?php echo $game['portfolio_foto']; ?>"
