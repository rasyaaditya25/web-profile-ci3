                        ...
                        <?php while ($web = $ambil->fetch_assoc()) { ?>
                            <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-web">
                                ...
                                <div class="portfolio-info">
                                    ...
                                    <a href="portfolio-details.php?id=<?php echo $web['id_portfolio']; ?>"
                                        title="More Details" class="details-link"><i class="bi bi-link-45deg"></i></a>
                                    <div class="mt-2">
                                        <a href="portfolio_edit.php?id=<?php echo $web['id_portfolio']; ?>"
                                            class="btn btn-warning btn-sm"><i class="bi bi-pencil-square"></i></a>
                                        <a href="portfolio_delete.php?id=<?php echo $web['id_portfolio']; ?>"
                                            class="btn btn-danger btn-sm"
                                            onclick="return confirm('Apakah Anda yakin ingin menghapus?');"><i class="bi bi-trash"></i></a>
                                    </div>
                                </div>
                            </div>
                        <?php } ?>
                            ...
                            <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-games">
                                ...
                                <div class="portfolio-info">
                                    ...
                                    <a href="../portfolio_photo/<?php echo $game['portfolio_foto']; ?>"
                                        title="<?php echo $game['judul_portfolio']; ?>"
                                        data-gallery="portfolio-gallery-games" class="glightbox preview-link"><i
                                            class="bi bi-zoom-in"></i></a>
                                    <a href="portfolio-details.php?id=<?php echo $game['id_portfolio']; ?>"
                                        title="More Details" class="details-link"><i class="bi bi-link-45deg"></i></a>
                                    <div class="mt-2">
                                        <a href="portfolio_edit.php?id=<?php echo $game['id_portfolio']; ?>"
                                            class="btn btn-warning btn-sm"><i class="bi bi-pencil-square"></i></a>
                                        <a href="portfolio_delete.php?id=<?php echo $game['id_portfolio']; ?>"
                                            class="btn btn-danger btn-sm"
                                            onclick="return confirm('Apakah Anda yakin ingin menghapus?');"><i class="bi bi-trash"></i></a>
                                    </div>
                                </div>
